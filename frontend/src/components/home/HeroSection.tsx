...
const HeroSection: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Massive blurred halo behind */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div
          className="w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] bg-gradient-to-tr from-purple-600/20 to-transparent rounded-full filter blur-3xl"
        />
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-6 lg:space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
            ...
            <br />
            <span className="text-white">Evolves with Reality</span>
          </h1>
        ...
        <div className="relative mt-8 lg:mt-0">
          <div className="relative group">
            <div className="absolute -inset-4 bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500" />
